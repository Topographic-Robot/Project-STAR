 ...
 */
static esp_err_t priv_pstar_bus_gpio_set_level(const bus_manager_t* manager,
                                         const char*          name, 
                                         gpio_num_t           pin_num, 
                                         uint32_t             level)
{
 ...
 * @return esp_err_t ESP_OK on success, or an error code.
 */
static esp_err_t priv_pstar_bus_gpio_get_level(const bus_manager_t* manager,
                                         const char*          name, 
                                         gpio_num_t           pin_num, 
                                         uint32_t*            level)
{
 ...
 * @return esp_err_t ESP_OK on success, or an error code.
 */
static esp_err_t priv_pstar_bus_gpio_isr_add(const bus_manager_t* manager,
                                       const char*          name, 
                                       gpio_num_t           pin_num, 
 ...
 * @return esp_err_t ESP_OK on success, or an error code.
 */
static esp_err_t priv_pstar_bus_gpio_isr_remove(const bus_manager_t* manager,
                                          const char*          name, 
                                          gpio_num_t           pin_num)
{
  esp_err_t result = ESP_OK;
...
void pstar_bus_gpio_init_default_ops(gpio_ops_t* ops)
{
  if (ops == NULL) {
    log_error(bus_gpio_tag, 
              "Init Error", 
...
esp_err_t pstar_bus_gpio_set_level(const bus_manager_t* manager,
                             const char*          name,
                             gpio_num_t           pin_num,
                             uint32_t             level)
{
...
esp_err_t pstar_bus_gpio_get_level(const bus_manager_t* manager,
                             const char*          name,
                             gpio_num_t           pin_num,
                             uint32_t*            level)
{
...
esp_err_t pstar_bus_gpio_isr_add(const bus_manager_t* manager,
                           const char*          name,
                           gpio_num_t           pin_num,
                           gpio_isr_t           isr_handler,
                           void*                args)
...
esp_err_t pstar_bus_gpio_isr_remove(const bus_manager_t* manager,
                              const char*          name,
                              gpio_num_t           pin_num)
{
  /* Validate input */
