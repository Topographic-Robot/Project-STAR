/* components/pstar_bus/include/bus_function_types.h */
...
typedef void (*pstar_i2c_transfer_complete_cb_t)(pstar_bus_event_t* event, 
                                                 void*              user_ctx);

typedef void (*pstar_i2c_error_cb_t)(pstar_bus_event_t* event, 
                                     esp_err_t          error, 
                                     void*              user_ctx);

/* SPI Callback Function Types */
typedef void (*pstar_spi_transfer_complete_cb_t)(pstar_bus_event_t* event, 
                                                 void*              user_ctx);

typedef void (*pstar_spi_error_cb_t)(pstar_bus_event_t* event, 
                                     esp_err_t          error, 
                                     void*              user_ctx);
...
typedef void (*pstar_uart_data_sent_cb_t)(pstar_bus_event_t* event, 
                                          size_t             len, 
                                          void*              user_ctx);

typedef void (*pstar_uart_error_cb_t)(pstar_bus_event_t* event, 
                                      esp_err_t          error, 
                                      void*              user_ctx);

/* GPIO Callback Function Types */
typedef void (*pstar_gpio_interrupt_cb_t)(pstar_bus_event_t* event, 
                                          void*              user_ctx);
...
typedef void (*pstar_sdio_transfer_complete_cb_t)(pstar_bus_event_t* event, 
                                                  void*              user_ctx);

typedef void (*pstar_sdio_error_cb_t)(pstar_bus_event_t* event, 
                                      esp_err_t          error, 
                                      void*              user_ctx);
