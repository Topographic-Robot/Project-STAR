...
pstar_bus_config_t* pstar_bus_config_create_i2c(const char*         name, 
                                          ...
                                          pstar_common_mode_t mode)
{
  pstar_bus_config_t* config = priv_pstar_bus_config_create_common(name, k_pstar_bus_type_i2c, mode);
  if (config == NULL) {
    return NULL;
  }
...
pstar_bus_config_t* pstar_bus_config_create_spi(const char*         name, 
                                          ...
                                          pstar_common_mode_t mode)
{
  pstar_bus_config_t* config = priv_pstar_bus_config_create_common(name, k_pstar_bus_type_spi, mode);
  if (config == NULL) {
    return NULL;
  }
...
pstar_bus_config_t* pstar_bus_config_create_uart(const char*         name, 
                                                ...
                                                pstar_common_mode_t mode)
{
  pstar_bus_config_t* config = priv_pstar_bus_config_create_common(name, k_pstar_bus_type_uart, mode);
  if (config == NULL) {
    return NULL;
  }
  ...
  config->config.uart.rx_timeout_ms  = 1000;  /* Set default timeout to 1000ms */
...
pstar_bus_config_t* pstar_bus_config_create_gpio(const char*         name, 
                                                pstar_common_mode_t mode)
{
  pstar_bus_config_t* config = priv_pstar_bus_config_create_common(name, k_pstar_bus_type_gpio, mode);
  if (config == NULL) {
    return NULL;
  }
...
pstar_bus_config_t* pstar_bus_config_create_sdio(const char*         name, 
                                                ...
                                                pstar_common_mode_t mode)
{
  pstar_bus_config_t* config = priv_pstar_bus_config_create_common(name, k_pstar_bus_type_sdio, mode);
  if (config == NULL) {
    return NULL;
  }
