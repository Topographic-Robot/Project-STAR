 ...
 */
static esp_err_t priv_pstar_bus_i2c_write(const bus_manager_t* manager,
                                    const char*          name,
                                    const uint8_t*       data, 
                                    size_t               len, 
                                    uint8_t              reg_addr, 
 ...
 * @return esp_err_t ESP_OK on success, or an error code.
 */
static esp_err_t priv_pstar_bus_i2c_read(const bus_manager_t* manager,
                                   const char*          name,
                                   uint8_t*             data, 
                                   size_t               len, 
                                   uint8_t              reg_addr, 
...
void pstar_bus_i2c_init_default_ops(i2c_ops_t* ops)
{
  if (ops == NULL) {
    log_error(bus_i2c_tag, 
              "Init Error", 
...
esp_err_t pstar_bus_i2c_write(const bus_manager_t* manager,
                        const char*          name,
                        const uint8_t*       data, 
                        size_t               len, 
                        uint8_t              reg_addr, 
...
esp_err_t pstar_bus_i2c_read(const bus_manager_t* manager,
                       const char*          name,
                       uint8_t*             data, 
                       size_t               len, 
                       uint8_t              reg_addr, 
