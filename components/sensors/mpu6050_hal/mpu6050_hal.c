...
/* XXX: TODO: FIXME: BUG: This shit don't work :< */
...
/* Sensitivity values in LSB/g as per the MPU6050 datasheet */
...
/* Sensitivity values in LSB/°/s as per the MPU6050 datasheet */
...
esp_err_t mpu6050_init(void *sensor_data)
{
    ...
    mpu6050_data->gyro_x      = mpu6050_data->gyro_y  = mpu6050_data->gyro_z  = 0.0;
    mpu6050_data->accel_x     = mpu6050_data->accel_y = mpu6050_data->accel_z = 0.0;
    ...
    ret = priv_i2c_write_reg_byte(k_mpu6050_config_cmd, k_mpu6050_config_dlpf_44hz,
                                  mpu6050_i2c_bus, mpu6050_i2c_address, mpu6050_tag);
    if (ret != ESP_OK) {
