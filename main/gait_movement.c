...
static leg_t s_legs[NUMBER_OF_LEGS] = {};
                                  ...
                                  float            relative_angle) 
{
  ...
  switch (joint_type) {
    ...
    case k_tibia:
      ...
      break;
    default:
      log_error(gait_tag, "Joint Error", "Invalid joint type: %u", joint_type);
                                      ...
                                      float            relative_angle)
{
  ...
  log_info(gait_tag, "Process Complete", "All motor angles set successfully");
  return ESP_OK;
}
